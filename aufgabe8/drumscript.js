...
const sound3 = new Audio('L08_task_material_assets_Keyboard_f.mp3.mp3');
const sound4 = new Audio('L08_task_material_assets_Keyboard_d.mp3.mp3');
const sound5 = new Audio('L08_task_material_assets_Keyboard_e.mp3.mp3');
const sound6 = new Audio('L08_task_material_assets_DrumPad_snare.mp3.mp3');
